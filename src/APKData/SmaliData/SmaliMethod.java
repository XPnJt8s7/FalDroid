...
public class SmaliMethod implements Serializable {
	...
	// private ArrayList<AndroidLine> linesList; //the linesString contains number
	// of AndroidLine in a method
	// private AndroidLine tmpLine;
	private ArrayList<MethodCalling> methodCalls = new ArrayList<>(); // a Android method contains number of Android
																		// calls
	private int kLine = 0;
	...
	public String getEntityMethodString() {
		String resultString = this.methodPackageString + ": " + this.methodNameString + "(" + this.methodArgsString
				+ ")" + returnValue;
		return resultString;
	}
